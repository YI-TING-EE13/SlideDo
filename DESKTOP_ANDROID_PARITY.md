...
Status: owner-approved qualification baseline with Stage 1 session-contract
behavior now implemented and verified; later stages remain planning-only. This
