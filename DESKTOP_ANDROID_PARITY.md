...
| PARTIAL | 6 | The Desktop slice exists but differs materially in move-history wording, solver UX, localization completeness, accessibility/adaptive manual evidence, or package scope. |
